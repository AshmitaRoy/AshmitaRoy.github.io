...
###Final Insights:
After scaling our inputs we can see that out of the factors we checked, the major effect on the median housing value was by median_income ie the median income of the housing block. However, this is a hasty judgement and possibly other questions must be delved into before declaring any results.
...
* Colour codes from https://www.color-hex.com/
* 
